...
#счётчики
COUNTERS = {
    "SBL": int(os.getenv("YM_COUNTER_SBL")),
    "PRO": int(os.getenv("YM_COUNTER_PRO")),
    "CIB": int(os.getenv("YM_COUNTER_CIB")),
    "INDIA": int(os.getenv("YM_COUNTER_INDIA")),
    "LEGAL": int(os.getenv("YM_COUNTER_LEGAL")),
}
...
def check_all_counters(slot_start: datetime, slot_end: datetime):
    ...
    for counter_name, counter_id in COUNTERS.items():
